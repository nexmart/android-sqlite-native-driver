/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Wed May 18 23:00:58 CEST 2016 ----! */
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_bind_parameter_index(long st, java.lang.String name)
 *     C function: int sqlc_st_bind_parameter_index(sqlc_handle_t st, const char *  name);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1bind_1parameter_1index__JLjava_lang_String_2(JNIEnv *env, jclass _unused, jlong st, jstring name) {
  ...
  if ( NULL == _strchars_name ) {
      (*env)->ThrowNew(env, (*env)->FindClass(env, "java/lang/OutOfMemoryError"),
                       "Failed to get UTF-8 chars for argument \"name\" in native dispatcher for \"sqlc_st_bind_parameter_index\"");
      return 0;
    }
  }
  _res = sqlc_st_bind_parameter_index((sqlc_handle_t) st, (char *) _strchars_name);
  if ( NULL != name ) {
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_clear_bindings(long stmt)
 *     C function: int sqlc_st_clear_bindings(sqlc_handle_t stmt);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1clear_1bindings__J(JNIEnv *env, jclass _unused, jlong stmt) {
  int _res;
  _res = sqlc_st_clear_bindings((sqlc_handle_t) stmt);
  return _res;
}
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_st_reset(long stmt)
 *     C function: int sqlc_st_reset(sqlc_handle_t stmt);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1st_1reset__J(JNIEnv *env, jclass _unused, jlong stmt) {
  int _res;
  _res = sqlc_st_reset((sqlc_handle_t) stmt);
  return _res;
}
