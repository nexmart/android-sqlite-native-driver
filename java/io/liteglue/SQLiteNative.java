...
public class SQLiteNative {
    ...
    /**
     * Interface to C language function: <br> <code> int sqlc_st_bind_parameter_index(sqlc_handle_t st, const char *  name); </code>
     */
    public static native int sqlc_st_bind_parameter_index(long st, String name);
    ...
    /**
     * Interface to C language function: <br> <code> int sqlc_st_clear_bindings(sqlc_handle_t stmt); </code>
     */
    public static native int sqlc_st_clear_bindings(long stmt);
    ...
    /**
     * Interface to C language function: <br> <code> int sqlc_st_reset(sqlc_handle_t stmt); </code>
     */
    public static native int sqlc_st_reset(long stmt);
